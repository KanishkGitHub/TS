...
function draw() {
  ...
  stroke(100)
  fill("blue")
  text("Press UP/DOWN arrow keys to move.",20,150)
  textSize(18)
  stroke(100)
  fill("white")
  text("To see instructions just release the left arrow key.",20,180)
  textSize(18)
  stroke(100)
  fill("white")
  text("Eat mango and burger to increase score and avoid bomb and electric shocker.",20,210)
  textSize(18)
  stroke(100)
  fill("white")
  text("After score 500, your new level starts and then you can growl by pressing RIGHT arrow key.",20,240)
  textSize(18)
  stroke(100)
  fill("white")
  text("After score 500, get ready to face the BOSS. To defeat it growl at it by pressing RIGHT arrow.",20,270)
  textSize(18)
  stroke(100)
  fill("white")
  text("DO NOT GO OUTSIDE THE FRAME!",20,292)
  textSize(18)
  stroke(100)
  fill("blue")
  text("Press left arrow key to start the game and press it whole time while playing the Dinosaur game.",20,120)
